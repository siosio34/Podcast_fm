...
ActiveRecord::Schema.define(version: 20151117151955) do
  ...
  create_table "episodes", force: :cascade do |t|
    ...
    t.string   "episode_thunbnail_file_name"
    t.string   "episode_thunbnail_content_type"
    t.integer  "episode_thunbnail_file_size"
    t.datetime "episode_thunbnail_updated_at"
